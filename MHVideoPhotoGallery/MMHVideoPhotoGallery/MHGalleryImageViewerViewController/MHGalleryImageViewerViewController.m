...
-(void)sharePressed{
    ...
    if (imageViewController.imageView.image != nil) {
        ...
        NSString *stringToShare = [self galleryViewController].stringToShare;
        
        NSArray *shareItems = (stringToShare) ? @[stringToShare, imageViewController.imageView.image] : @[imageViewController.imageView.image];
        
        UIActivityViewController *act = [UIActivityViewController.alloc initWithActivityItems:shareItems applicationActivities:nil];
